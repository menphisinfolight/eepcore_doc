...
> ⚠️ **舊版遺留（未使用）**：SYS_TODOHIS、SYS_TODOLIST、SYS_SSO_SOLUTION、SYS_INFOPAY、SYS_ANYQUERY、MENUTABLELOG、SYS_FLDEFINITION、SYS_EXTAPPROVE
>
...
- [SYSERRLOG](./SYSERRLOG.md) — 系統錯誤日誌表（⚠️ C# 無直接引用）
