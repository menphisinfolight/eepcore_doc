...
|------|-----------|--------|-------|
| SEQ | `decimal(12,0)` | `number(12)` | `decimal(12,0)` |
| DEFAULT_VALUE | `nvarchar(1024)` | `varchar2(1024)` | `nvarchar(1024)` |

各資料庫其餘欄位定義一致，Oracle 使用 `varchar2` 取代 `nvarchar`。TABLE_NAME 和 FIELD_NAME 早期為較短長度，後透過 ALTER TABLE 擴展為 `nvarchar(200)`。
